...
#   we_Q = 1e-10/2#.25e-10 + 0.125e-10
#   wi_Q = 1e-10/2#.25e-10 + 0.125e-10
#   aff_Q = 1e-11
#   eff_Q = aff_Q
#   if justEI:
...
# # plt.show()
# # obs4,stim_lfp = run(({'t_stop':t_stop,'Je_scale':jes,'Ji_scale':jis,'dbs_times':np.arange(2500,7500,dbs_isi),'progress':True,'R_obs':['lfp']},{'progress':True}))
